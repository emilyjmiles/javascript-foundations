...
describe('Medusa', function() {
  ...
  it('should have a name', function() {
    var medusa1 = new Medusa('Emily'); // instantiate a Medusa object with your name as an argument
    var medusa2 = new Medusa('Anna'); // instantiate another Medusa object with someone else's name as an argument

    assert.equal(medusa1.name, 'Emily'); // assert that the first medusa's name is your name
    assert.equal(medusa2.name, 'Anna'); // assert that the second medusa's name is the other name
